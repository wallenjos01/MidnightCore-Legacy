...
public class Adapter_v1_19_R3 implements SpigotAdapter {


    private SkinUpdater_v1_19_R3 updater;
    ...
    public boolean init() {
        ...
        updater = new SkinUpdater_v1_19_R3();
        return updater.init();
    }
    ...
    public void setTag(ItemStack is, ConfigSection sec) {
        ...
        try {
            ...
            MidnightCoreAPI.getLogger().warn(ex.getMessage());
            MidnightCoreAPI.getLogger().warn(MItemStack.toNBT(sec));
        }
    }
    ...
    public ConfigSection getTag(ItemStack is) {
        ...
        return JSONCodec.loadConfig(cmp.f_()).asSection();
    }
    ...
    public ConfigSection getTag(Player pl) {
        ...
        return JSONCodec.loadConfig(tag.f_()).asSection();
    }
